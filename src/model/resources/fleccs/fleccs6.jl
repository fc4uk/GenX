...
function fleccs6(EP::Model, inputs::Dict)
	...
	# eq1. 
    @expression(EP, eFuel[y in FLECCS_ALL,t=1:T], dfGen_ccs[!,:P1][1+n*(y-1)] * vP_gt[y,t] )
	...
	#eq 4 
	@constraint(EP, [y in FLECCS_ALL,t=1:T], vCAPTURE_pcc[y,t] <= dfGen_ccs[!,:P4][1+n*(y-1)] * eCO2_flue[y,t])

	# eq 5
	@expression(EP, eCO2_vent_pcc[y in FLECCS_ALL,t=1:T], eCO2_flue[y,t] - vCAPTURE_pcc[y,t])

	# eq 6
	@expression(EP, ePower_use_pcc[y in FLECCS_ALL,t=1:T], dfGen_ccs[!,:P6][1+n*(y-1)] * vCAPTURE_pcc[y,t])
