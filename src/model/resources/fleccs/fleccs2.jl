...
function fleccs2(EP::Model, inputs::Dict)
	...
	@variables(EP, begin
        vCAPTURE[y in FLECCS_ALL,1:T] >= 0 # tonne/h of captured CO2
        vREGEN[y in FLECCS_ALL,1:T] >= 0 # tonne/h of regenerated CO2
	...
	@expression(EP, ePower_st_low[y in FLECCS_ALL,t=1:T], eSteam_low[y,t]/dfGen_ccs[!,:pHeatRate_st_low][1+n*(y-1)])
